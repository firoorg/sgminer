...
#define ARGON2_MIN_MEMORY (2 * ARGON2_SYNC_POINTS) /* 2 argon_blocks per slice */
...
/**
 * Argon2d: Version of Argon2 that picks memory argon_blocks depending
...
/**
 * Argon2i: Version of Argon2 that picks memory argon_blocks
