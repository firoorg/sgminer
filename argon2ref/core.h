...
enum argon2_core_constants {
    ...
    ARGON2_argon_block_SIZE = 1024,
    ARGON2_QWORDS_IN_argon_block = ARGON2_argon_block_SIZE / 8,
    ARGON2_OWORDS_IN_argon_block = ARGON2_argon_block_SIZE / 16,

    /* Number of pseudo-random values generated by one call to Blake in Argon2i
       to
       generate reference argon_block positions */
    ARGON2_ADDRESSES_IN_argon_block = 128,
...
uint64_t v[ARGON2_QWORDS_IN_argon_block]; 
...
*/
/*
 * Argon2 position: where we construct the argon_block right now. Used to distribute
