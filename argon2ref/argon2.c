...
int argon2_ctx(argon2_context *context, argon2_type type) {
    ...
    if (memory_argon_blocks < 2 * ARGON2_SYNC_POINTS * context->lanes) {
        memory_argon_blocks = 2 * ARGON2_SYNC_POINTS * context->lanes;
    }

    segment_length = memory_argon_blocks / (context->lanes * ARGON2_SYNC_POINTS);
    /* Ensure that all segments have equal length */
    memory_argon_blocks = segment_length * (context->lanes * ARGON2_SYNC_POINTS);
